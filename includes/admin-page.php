	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<!-- <h2 class="nav-tab-wrapper">
				<a href="?page=saucyss-options&tab=functional" class="nav-tab <?php echo $active_tab == 'functional' ? 'nav-tab-active' : ''; ?>"><?php _e('Functional Options', 'saucyss_domain'); ?></a>
				<a href="?page=saucyss-options&tab=styling" class="nav-tab <?php echo $active_tab == 'styling' ? 'nav-tab-active' : ''; ?>"><?php _e('Styling Options', 'saucyss_domain'); ?></a>
			</h2> -->

			<?php // if ( !isset($active_tab) || isset($active_tab) && $active_tab == "functional") { ?>

				<h3><?php _e('Functional Settings', 'saucyss_domain'); ?></h3>
